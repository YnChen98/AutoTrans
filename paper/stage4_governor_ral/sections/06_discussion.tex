...
stress. A single combined aggregate would hide this structure and could make a method
...
the highest mean valid count, highest worst-protocol count, and lowest total
regret under the tested protocols. This does not mean it is statistically
superior, universal, or guaranteed safe. The claim is narrower: among the
...
These labels are diagnostic rather than definitive root-cause attribution.
...
on Trials 4, 5, and 6, and \texttt{risk\_adapter\_v2} lacks a matched stress
result for the balanced table. The source, training, calibration, and
confidence behavior of the risk scores also require clearer documentation
before a stronger journal extension.
