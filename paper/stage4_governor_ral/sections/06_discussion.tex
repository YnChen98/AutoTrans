...
claim for Risk Adapter v1 more meaningful because it is measured
against strong specialists rather than weak baselines.

\subsection{Balanced Robustness as a Protocol-Level Criterion}

Risk Adapter v1 is the current balanced protagonist because it has
...
on Trials 4, 5, and 6, and Risk Adapter v2 lacks a matched stress
