...
\begin{figure*}[t]
  ...
  \begin{minipage}{0.32\textwidth}
    ...
    \scriptsize
    (a) T4 goal-reissue, Risk Adapter v2.1
  \end{minipage}
  \hfill
  \begin{minipage}{0.32\textwidth}
    \centering
    ...
    \scriptsize
    (b) T4 goal-reissue, Fixed Scale 0.80
  \end{minipage}
  \hfill
  \begin{minipage}{0.32\textwidth}
    \centering
    ...
    \scriptsize
    (c) T4 goal-reissue, Risk Adapter v1
  \end{minipage}
  \par\medskip
  \begin{minipage}{0.32\textwidth}
    \centering
    ...
    \scriptsize
    (d) T6 single-goal, Wind-Level 0.85
  \end{minipage}
  ...
  \begin{minipage}{0.32\textwidth}
    ...
    \scriptsize
    (e) T6 single-goal, Risk Adapter v2.1
  \end{minipage}
  \caption{Representative trace case studies. Panels (a)--(c) compare Trial 4
  goal-reissue stress behavior for Risk Adapter v2.1, Fixed Scale 0.80, and
  Risk Adapter v1. Panels (d)--(e) show the Trial 6 single-goal bottleneck
  comparison. These representative traces are qualitative mechanism evidence
  only, not population-level causal evidence.}
