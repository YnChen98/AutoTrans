...
strongest in both protocols. \texttt{windlevel\_s085} is the single-goal
...
current method, with the highest mean valid count (24.0/30), highest
worst-protocol valid count (23/30), and lowest total regret (2). By contrast,
