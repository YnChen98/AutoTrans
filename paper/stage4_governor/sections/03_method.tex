...
because it gives the best cross-protocol balance in the current evaluation. It
achieves 25/30 strict-valid runs in the single-goal mission protocol and 23/30
in the goal-reissue stress protocol, yielding the best mean valid count
(24.0/30), best worst-protocol valid count (23/30), and lowest total regret
