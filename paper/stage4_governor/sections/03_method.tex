...
\texttt{LogisticRegression} models for the 3 s and 5 s windows. Unavailable
scores are published as \texttt{-1} and do not trigger risk reductions. The
final RA-L manuscript must still pin the exact exported model metadata,
training dataset version, feature schema, and calibration caveat before
submission.
