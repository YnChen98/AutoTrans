...
- `goal_repeat=10` reproduced command-saturation-before-NaN divergence in 1
  out of 3 root-cause smoke runs.
- The failed `goal_repeat=10` smoke3 run did not show reference nonfinite data
  or reference position/velocity jumps.
- The observed sequence supports command saturation / command NaN propagation
  as the proximate failure mechanism.
- Repeated goal remains a possible trigger, but reference discontinuity is not
  proven.
...
| --- | ---: | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- | ---: | --- |
| smoke1 | 1 | not recorded | true | false | nan | 16.991189 | 2.493061 | 2.700187 | 0.000000 | 1.000000 | nan | nan | nan | not recorded | `command_saturation_without_divergence` |
| smoke2 | 10 | `/home/cccyn2004/projects/autotrans_ws/src/AutoTrans/experiments/logs/autotrans_log_20260510_232309.csv` | true | false | nan | 14.473151 | 2.409328 | 2.687449 | 0.000000 | 1.000000 | nan | nan | nan | not recorded | `command_saturation_without_divergence` |
| smoke3 | 10 | `/home/cccyn2004/projects/autotrans_ws/src/AutoTrans/experiments/logs/autotrans_log_20260510_232555.csv` | false | true | 19.850035 | 151.662901 | 41.344307 | 42.631983 | 389.140344 | 1.000000 | nan | nan | nan | 2.438584 | `command_saturation_before_nan` |
| smoke4 | 10 | `/home/cccyn2004/projects/autotrans_ws/src/AutoTrans/experiments/logs/autotrans_log_20260510_232856.csv` | true | false | nan | 13.112674 | 2.515147 | 2.559920 | 0.000000 | 1.000000 | nan | nan | nan | not recorded | `command_saturation_without_divergence` |
...
smoke1, smoke2, and smoke4. Therefore, saturation alone is not sufficient to
classify a run as failed in these smoke diagnostics.

The failure-relevant pattern observed in smoke3 is command saturation followed
by command NaN and then state divergence. The downstream high swing, high
speed, and position jumps appeared after the command NaN event.

`goal_repeat=10` can reproduce the issue, but it is not yet proven as the root
cause. The repeated goal remains a possible trigger, while planner reference
discontinuity is not supported by these smoke observations.

## Research Decision

- Do not continue Trial 6 fair expansion yet.
- Run additional `goal_repeat=1` diagnostics for a balanced comparison.
- Consider later command NaN guard diagnostics.
